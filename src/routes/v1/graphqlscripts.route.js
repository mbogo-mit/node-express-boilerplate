...
const validator = require('../../validations/graphqlscripts.validation');
const controller = require('../../controllers/graphqlscripts.controller');
...
const endpoints = ['/create/:graphqlscriptsname', '/delete/:graphqlscriptsnameID', '/execute/:graphqlscriptsnameID'];
